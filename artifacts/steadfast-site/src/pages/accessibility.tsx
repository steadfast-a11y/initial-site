...
export default function Accessibility() {
  return (
    <>
      <Helmet>
        <title>Accessibility Statement | LetEveryoneIn</title>
        <meta name="description" content="LetEveryoneIn is committed to WCAG 2.1 AA standards. Learn how to report accessibility issues and our commitment to ongoing improvement." />
        <meta property="og:title" content="Accessibility Statement | LetEveryoneIn" />
        ...
        <meta name="twitter:title" content="Accessibility Statement | LetEveryoneIn" />
      ...
      <section className="py-20 px-4 bg-background min-h-screen">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="prose prose-lg dark:prose-invert">
            <p>
              LetEveryoneIn (a service of Steadfast Accessibility LLC) is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone, and applying the relevant accessibility standards.
            </p>

...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About Dan Harrison | LetEveryoneIn</title>
        ...
        <meta property="og:title" content="About Dan Harrison | LetEveryoneIn" />
        ...
        <meta name="twitter:title" content="About Dan Harrison | LetEveryoneIn" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <div>
              <div className="aspect-square rounded-2xl mb-8 border-4 border-muted shadow-lg overflow-hidden">
                <img src={danPhoto} alt="Dan Harrison, founder of LetEveryoneIn" className="w-full h-full object-cover object-top" />
              </div>

...
export default function Resources() {
  ...
  return (
    <>
      <Helmet>
        <title>ADA Accessibility Resources for Small Business | LetEveryoneIn</title>
        ...
        <meta property="og:title" content="ADA Accessibility Resources for Small Business | LetEveryoneIn" />
        ...
        <meta name="twitter:title" content="ADA Accessibility Resources for Small Business | LetEveryoneIn" />
